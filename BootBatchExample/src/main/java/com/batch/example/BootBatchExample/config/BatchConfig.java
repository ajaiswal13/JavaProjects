...
public class BatchConfig {
    ...
    public FlatFileItemReader<Product> reader(){
        return new FlatFileItemReaderBuilder<Product>()
                .name("itemReader")
                .resource(new ClassPathResource("data.csv")) //This means that file is present in resource folder
                .delimited()
    ...
    public ItemWriter<Product> itemWriter(DataSource dataSource){
        return new JdbcBatchItemWriterBuilder<Product>()
                ...
                .dataSource(dataSource) //Used for connectivity - created automatically when application runs
                .beanMapped() //for mapping between the values :product_id etc to the data members of Product class
                .build();
    }
}
